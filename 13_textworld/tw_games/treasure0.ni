...
Test quest0_0 with "go west / go north / take insect"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, make an attempt to travel west. Following that, take a trip north. Following that, lift the ".
The objective part 1 is some text that varies. The objective part 1 is "insect from the floor of the dish-pit. Alright, thanks!".
