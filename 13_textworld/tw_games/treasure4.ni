...
The r_0 and the r_7 and the r_1 and the r_8 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 are rooms.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You arrive in a launderette. An usual one. I guess you better just go and list everything you see here.
...
The launderette part 1 is some text that varies. The launderette part 1 is "[if c_0 is open and the c_0 contains nothing] The drawer is empty, what a horrible day![end if]".
...
The restroom part 1 is some text that varies. The restroom part 1 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The basket is empty![end if]".
The restroom part 2 is some text that varies. The restroom part 2 is " You see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0].[end if]".
The restroom part 3 is some text that varies. The restroom part 3 is "[if there is nothing on the s_0]The table appears to be empty.[end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "I am pleased to announce that you are now in the shower.

 Look out! It's a- oh, never mind, it's just a board. The board is normal.[if there is something on the s_1] On the board you see [a list of things on the s_1].[end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You arrive in a workshop. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You see a suitcase. I mean, just wow! Isn't TextWorld just the best?[if c_2 is open and there is something in the c_2] The suitcase contains [a list of things in the c_2].[end if]".
...
The workshop part 2 is some text that varies. The workshop part 2 is " You see a portmanteau.[if c_3 is open and there is something in the c_3] The portmanteau contains [a list of things in the c_3]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The workshop part 3 is some text that varies. The workshop part 3 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The portmanteau is empty![end if]".
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical kind of place. Okay, just remember what you're here to do, and everything will go great.
 ...
 You see a shelf. You wonder idly who left that here. [if there is something on the s_2]On the shelf you see [a list of things on the s_2].[end if]".
The office part 1 is some text that varies. The office part 1 is "[if there is nothing on the s_2]The shelf appears to be empty.[end if]".
The office part 2 is some text that varies. The office part 2 is " What's that over there? It looks like it's an armchair. The armchair is normal.[if there is something on the s_3] On the armchair you can see [a list of things on the s_3].[end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in a studio. A typical one. You can barely contain your excitement.

 You can make out [if c_4 is locked]a locked[else if c_4 is open]an opened[otherwise]a closed[end if]".
The studio part 1 is some text that varies. The studio part 1 is " locker here.[if c_4 is open and there is something in the c_4] The locker contains [a list of things in the c_4].[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_4 is open and the c_4 contains nothing] The locker is empty, what a horrible day![end if]".
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. A typical one.
 ...
 You scan the room for a workbench, and you find a workbench. The workbench is normal.[if there is something on the s_4] On the workbench you make out [a list of things on the s_4].[end if]".
The basement part 1 is some text that varies. The basement part 1 is "[if there is nothing on the s_4] The workbench appears to be empty.[end if]".
...
The r_0 and the r_7 and the r_1 and the r_8 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 are rooms.
The r_0 and the r_7 and the r_1 and the r_8 and the r_2 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go west / go west / go south / go south / take bug"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your first objective is to make an effort to head north. With that done, try to go west. After that, make an att".
The objective part 1 is some text that varies. The objective part 1 is "empt to go west. And then, attempt to go south. And then, attempt to go to the south. Then, pick-up the bug from the floor of the workshop. That's it!".
